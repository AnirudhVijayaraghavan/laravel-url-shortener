<div class="bg-white shadow rounded-lg p-6">
    ...
    <div class="flex items-center justify-between mb-4">
        <h2 class="text-2xl font-bold text-gray-800">User URL Records</h2>
        ...
        <table class="min-w-full divide-y divide-gray-200 table-fixed">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th class="px-2 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Clicks
                    </th>
            ...
            <tbody class="divide-y divide-gray-200">
                @foreach ($results as $record)
                    <tr>
                        ...
                        <td class="px-2 py-4 text-sm text-gray-900 break-words">{{ $record->clickCount }}</td>
                        <td class="px-2 py-4 text-sm text-gray-900 break-words">{{ $record->user->username }}
                        </td>
                        ...
                        <td class="px-2 py-4 text-sm break-words">
                            <div class="flex space-x-2">
                                ...
                                <a wire:navigate href="/siteadmin/{{ $record->id }}/edit"
                                    ...
                                    <div x-show="open" class="fixed inset-0 flex items-center justify-center z-50"
                                        ...
                                        <div class="bg-white rounded-lg p-6 z-10 max-w-sm mx-auto">
                                            ...
                                            <div class="flex justify-end space-x-4">
                                                ...
                                                <form action="/siteadmin/{{ $record->id }}/delete/" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit"
